      ...
      <div className="w-full max-w-[440px]">
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-8 sm:p-10">
          ...
          <div className="mb-8 flex flex-col items-center">
            ...
            <h2 className="text-2xl font-bold text-slate-900 tracking-tight text-center">Start your free trial</h2>
            <p className="text-slate-500 text-sm font-medium mt-1">Professional GST billing for your business</p>
          </div>
          ...
          <p className="mt-8 text-center text-sm font-medium text-slate-500">
            ...
            <Link to="/login" className="text-slate-900 font-bold hover:underline">Log in</Link>
          </p>
        </div>
