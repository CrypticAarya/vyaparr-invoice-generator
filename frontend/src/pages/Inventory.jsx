...
export default function Inventory() {
  ...
  const onboardProductMutation = useCreateProduct();
  const modifyProductMutation = useUpdateProduct();
  const archiveProductMutation = useDeleteProduct();
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const mutation = editingProduct ? modifyProductMutation : onboardProductMutation;
    
    mutation.mutate(
      editingProduct ? { id: editingProduct.id, data: formData } : formData,
      {
        ...
        actions={
          <>
            ...
            <Button 
              ...
              isLoading={onboardProductMutation.isPending || modifyProductMutation.isPending}
            >
